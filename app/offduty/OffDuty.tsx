...
const travelSummary = [
  { label: "คำขอทั้งหมด", value: 18, icon: <DocumentTextIcon className="w-6 h-6" /> },
  { label: "อยู่ระหว่างตรวจสอบ", value: 5, icon: <ClockIcon className="w-6 h-6" /> },
  { label: "อนุมัติแล้ว", value: 9, icon: <CalendarDaysIcon className="w-6 h-6" /> },
  { label: "ไม่อนุมัติ", value: 4, icon: <BriefcaseIcon className="w-6 h-6" /> },
];
...
const rows = [
  ...
  },
  {
    id: 2,
    date: "20 พ.ค. 2567",
    subject: "ประชุมเตรียมพร้อมน้ำหลาก",
...
export default function OffDutyPage() {
  ...
  return (
    <div className="flex">
      <AppSidebar collapsed={collapsed} activePage="travel" />
        ...
        <div className="p-6 space-y-6">
          <div className="bg-white rounded-3xl shadow p-6">
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              ...
              <Link href="/offduty/new" className="inline-flex items-center gap-2 rounded-full bg-blue-600 px-5 py-3 text-sm font-semibold text-white shadow-sm hover:bg-blue-700 transition">
          ...
          <div className="bg-white rounded-3xl shadow p-6">
            <div className="flex items-center justify-between mb-5">
              <div>
                ...
                <p className="text-sm text-slate-500">แสดงคำขอไปราชการล่าสุด</p>
              </div>
